...
export const filters = [
    ...
    },
    {
        ...
        name: 'Category',
        options: [
            { value: 'smartphones', label: 'New Arrivals', checked: false },
            { value: 'laptops', label: 'Sale', checked: false },
